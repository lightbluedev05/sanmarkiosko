...
import { Home, ShoppingBag, PlusSquare, User, Search, Settings, HelpCircle, LogOut } from "lucide-react";
  ...
  return (
    <aside className="hidden h-full w-72 shrink-0 flex-col border-r bg-card md:flex sidebar-gradient">
      ...
      <div className="p-4 shrink-0 border-t">
        <div className="group relative flex items-center gap-3 rounded-[1.5rem] bg-white p-2.5 shadow-sm border-2 transition-all hover:shadow-md">
          <Link href="/perfil" className="flex flex-1 items-center gap-3 overflow-hidden">
            ...
            <div className="flex-1 overflow-hidden text-left">
              <p className="text-xs font-black text-foreground truncate">Juan Estudiante</p>
              <p className="text-[9px] font-bold text-muted-foreground truncate">Ciencias Contables</p>
            </div>
          </Link>
